...
public class Student_Test {
	...
	public void test() throws PersonException {
		...
		Date fallStart = new Date(25, 8, 27); //August 27, 2015
		Date fallEnd = new Date(25, 12, 21); //December 21, 2105
		Date springStart = new Date(26, 2, 7); //February 7, 2016
		Date springEnd = new Date(26, 5, 29); //May 9, 2016
		...
		Student stud01 = new Student("John", "Jacob", "Smith", new Date(), eMajor.BUSINESS, "100 Main Street","5555555555", "myemail01@gmail.com");
		Student stud02 = new Student("John", "Jacob", "Johnson", new Date(), eMajor.PHYSICS, "100 Main Street","5555555555", "myemail02@gmail.com");
		Student stud03 = new Student("John", "Jacob", "Bedford", new Date(), eMajor.CHEM, "100 Main Street","5555555555", "myemail03@gmail.com");
		Student stud04 = new Student("John", "Jacob", "Wilkerson", new Date(), eMajor.COMPSI, "100 Main Street","5555555555", "myemail04@gmail.com");
		Student stud05 = new Student("John", "Jacob", "James", new Date(), eMajor.NURSING, "100 Main Street","5555555555", "myemail05@gmail.com");
		Student stud06 = new Student("John", "Jacob", "Richardson", new Date(), eMajor.BUSINESS, "100 Main Street","5555555555", "myemail06@gmail.com");
		Student stud07 = new Student("John", "Jacob", "Obama", new Date(), eMajor.PHYSICS, "100 Main Street","5555555555", "myemail07@gmail.com");
		Student stud08 = new Student("John", "Jacob", "Bush", new Date(), eMajor.CHEM, "100 Main Street","5555555555", "myemail08@gmail.com");
		Student stud09 = new Student("John", "Jacob", "Fallon", new Date(), eMajor.COMPSI, "100 Main Street","5555555555", "myemail09@gmail.com");
		Student stud10 = new Student("John", "Jacob", "Trump", new Date(), eMajor.NURSING, "100 Main Street","5555555555", "myemail10@gmail.com");
		...
		double stud01GPA = (((stud01Physics.getGrade()+stud01Econ.getGrade()+stud01Compsci.getGrade())/3)/20)-1;
		assert(stud01GPA == ((((75+80+85)/3)/20)-1));
		
		double stud02GPA = (((stud02Physics.getGrade()+stud02Econ.getGrade()+stud02Compsci.getGrade())/3)/20)-1;
		assert(stud02GPA == ((((75+81+85)/3)/20)-1));
		
		double stud03GPA = (((stud03Physics.getGrade()+stud03Econ.getGrade()+stud03Compsci.getGrade())/3)/20)-1;
		assert(stud03GPA == ((((85+84+85)/3)/20)-1));
		
		double stud04GPA = (((stud04Physics.getGrade()+stud04Econ.getGrade()+stud04Compsci.getGrade())/3)/20)-1;
		assert(stud04GPA == ((((97+67+57)/3)/20)-1));
		
		double stud05GPA = (((stud05Physics.getGrade()+stud05Econ.getGrade()+stud05Compsci.getGrade())/3)/20)-1;
		assert(stud05GPA == ((((85+88+88)/3)/20)-1));
		
		double stud06GPA = (((stud06Physics.getGrade()+stud06Econ.getGrade()+stud06Compsci.getGrade())/3)/20)-1;
		assert(stud06GPA == ((((75+86+95)/3)/20)-1));
	
		double stud07GPA = (((stud01Physics.getGrade()+stud01Econ.getGrade()+stud01Compsci.getGrade())/3)/20)-1;
		assert(stud07GPA == ((((79+60+75)/3)/20)-1));
		
		double stud08GPA = (((stud08Physics.getGrade()+stud08Econ.getGrade()+stud08Compsci.getGrade())/3)/20)-1;
		assert(stud08GPA == ((((85+88+89)/3)/20)-1));
	
		double stud09GPA = (((stud09Physics.getGrade()+stud09Econ.getGrade()+stud09Compsci.getGrade())/3)/20)-1;
		assert(stud09GPA == ((((91+65+77)/3)/20)-1));
		
		double stud10GPA = (((stud10Physics.getGrade()+stud10Econ.getGrade()+stud10Compsci.getGrade())/3)/20)-1;
		...
		double physicsAvgGrade = (stud01Physics.getGrade()+stud02Physics.getGrade()+stud03Physics.getGrade()+
				stud04Physics.getGrade()+stud05Physics.getGrade()+stud06Physics.getGrade()+stud07Physics.getGrade()+
				stud08Physics.getGrade()+stud09Physics.getGrade()+stud10Physics.getGrade())/10;
		...
		double compsciAvgGrade = (stud01Compsci.getGrade()+stud02Compsci.getGrade()+stud03Compsci.getGrade()+
				stud04Compsci.getGrade()+stud05Compsci.getGrade()+stud06Compsci.getGrade()+stud07Compsci.getGrade()+
				stud08Compsci.getGrade()+stud09Compsci.getGrade()+stud10Compsci.getGrade())/10;
		assert(compsciAvgGrade == (85+85+85+57+88+95+75+89+77+98)/10);
	
		
		eMajor stud01OldMajor = stud01.getMajor();
		stud01.setMajor(eMajor.NURSING);
